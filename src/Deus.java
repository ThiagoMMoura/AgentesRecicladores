...
public class Deus {
    ...
    private final MundoAgente out;

    public Deus(MundoAgente out,int dimenssaoAmbiente,int qtdLixos,int qtdLixeiras, int qtdAgentes) {
        this.out = out;
    ...
    public void iniciarCiclo(){
        for(Agente ag: agentes){
            ...
            try {
                ...
                Logger.getLogger(Deus.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
